...
\textbf{Bengali LLM tokenizers} (2): Kotha-1 \cite{kotha2026} (our prior work; 32K BPE trained on 1.5GB Bengali text with NFC normalization) and LilTii v0.2 \cite{liltii2026} (49K BPE trained on Bengali+English).
